...
if (isset($_POST['mgs'])) {
   ...
   $sql = mysqli_query($conn,"UPDATE `blood_doner` SET `donor_name`='$donor_name',`donor_bloodgroup`='$donor_bloodgroup',`donor_area`='$donor_area',`donor_mobile`='$donor_mobile',`status`='$status' WHERE id='$id'");
}
